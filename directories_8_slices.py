...
with open(file_path) as f:
	...
	for (k, v) in data.items():
		if v['slices'] == 8 and float(v['pass_prob']) < 40 and len(v['series']) == 1:
...
mtt_files_path = "/Users/camilledunning/Desktop/Code/iSchemaView/mtt_files_8_slices"
tmax_files_path = "/Users/camilledunning/Desktop/Code/iSchemaView/tmax_files_8_slices"
